...
func (route *Route) DeleteFunc(handlerFunc http.HandlerFunc) *Route {
	return route.Delete(handlerFunc)
}
...
func (route *Route) PatchFunc(handlerFunc http.HandlerFunc) *Route {
	return route.Patch(handlerFunc)
}

func (route *Route) Patch(handler http.Handler) *Route {
	return route.Handle(handler, "PATCH")
}

func (route *Route) PostFunc(handlerFunc http.HandlerFunc) *Route {
	return route.Post(handlerFunc)
}
